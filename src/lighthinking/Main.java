...
public class Main {
	...
	// TODO se for para ter outros modos vai ser necessário um enum algures e
	// mudar os construtores

	public static void main()
			throws UnknownHostException, IOException, TimeoutException, UnimplementedMethod, InterruptedException {
		...
		AgentManager agentManager = new AgentManager(new Config(), mainContainer);
		// simulation loop
		while (true) {
